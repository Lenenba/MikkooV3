...
class OnboardingController extends Controller
{
    public function index(Request $request): JsonResponse
    {
        ...
        $user->loadMissing(['address', 'parentProfile', 'babysitterProfile']);
        ...
        return response()->json([
            ...
            'profile' => $user->isBabysitter()
                ? BabysitterProfileResource::make($user->babysitterProfile)
                : ParentProfileResource::make($user->parentProfile),
            'user' => new UserResource($user),
        ]);
    }

    public function storeProfile(OnboardingProfileRequest $request): JsonResponse
    {
        $user = $request->user();
    ...
    public function storeAvailability(OnboardingAvailabilityRequest $request): JsonResponse
    {
        $user = $request->user();
        if (! $user) {
            return response()->json(['message' => 'Unauthenticated.'], 401);
    ...
    public function finish(Request $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'redirect' => route('search.babysitter'),
        ]);
    }
