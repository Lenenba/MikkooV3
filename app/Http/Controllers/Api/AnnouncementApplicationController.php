    ...
    public function store(Request $request, Announcement $announcement): JsonResponse
    {
        ...
        if ($announcement->status !== 'open') {
            return response()->json([
                'message' => __('announcements.application_errors.not_open'),
            ], 422);
        }
        ...
        if (AnnouncementApplication::query()
            ...
            ->exists()) {
            return response()->json([
                'message' => __('announcements.application_errors.already_applied'),
            ], 422);
        }
        ...
        if (! $schedule['start_date'] || ! $schedule['start_time'] || ! $schedule['end_time']) {
            return response()->json([
                'message' => __('announcements.application_errors.not_scheduled'),
            ], 422);
        }

        if (! $this->canBabysitterApply($user->id, $schedule)) {
            return response()->json([
                'message' => __('announcements.application_errors.slot_taken'),
            ], 422);
        }
        ...
        if (empty($matchedServices)) {
            return response()->json([
                'message' => __('announcements.application_errors.no_matching_service'),
            ], 422);
        }
        ...
        return response()->json([
            'application' => new AnnouncementApplicationResource($application),
        ], 201);
    }

    public function accept(Request $request, Announcement $announcement, AnnouncementApplication $application): JsonResponse
    {
        $user = $request->user();
        ...
        if ($application->status !== AnnouncementApplication::STATUS_PENDING) {
            return response()->json([
                'message' => __('announcements.application_errors.cannot_accept'),
            ], 422);
        }
        ...
        if ($alreadyAccepted) {
            return response()->json([
                'message' => __('announcements.application_errors.already_confirmed'),
            ], 422);
        }
        ...
        return response()->json([
            'message' => __('flash.application.confirmed'),
            'application' => new AnnouncementApplicationResource($application),
        ]);
    }

    public function reject(Request $request, Announcement $announcement, AnnouncementApplication $application): JsonResponse
    {
        $user = $request->user();
        if (! $user || ! $user->isParent()) {
            return response()->json(['message' => 'Forbidden.'], 403);
        ...
        if ($application->status !== AnnouncementApplication::STATUS_PENDING) {
            return response()->json([
                'message' => __('announcements.application_errors.cannot_reject'),
            ], 422);
        }
        ...
        return response()->json([
            'message' => __('flash.application.rejected'),
            'application' => new AnnouncementApplicationResource($application),
        ]);
    }

    public function withdraw(Request $request, Announcement $announcement, AnnouncementApplication $application): JsonResponse
    {
        $user = $request->user();
        if (! $user || ! $user->isBabysitter()) {
            return response()->json(['message' => 'Forbidden.'], 403);
        ...
        if ($application->status !== AnnouncementApplication::STATUS_PENDING) {
            return response()->json([
                'message' => __('announcements.application_errors.cannot_withdraw'),
            ], 422);
        }
        ...
        return response()->json([
            'message' => __('flash.application.withdrawn'),
            'application' => new AnnouncementApplicationResource($application),
        ]);
    }
